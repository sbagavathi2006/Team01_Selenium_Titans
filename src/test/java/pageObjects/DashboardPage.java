...
public class DashboardPage {
	...
	By dashboardProfileIcon = By.xpath(
			"//div[@class='h-8 w-8 rounded-full bg-[#6A5ACD] flex items-center justify-center mr-2']//*[name()='svg']//*[name()='path' and contains(@d,'M19 21v-2a')]");
	By dashboardBellIcon = By.xpath(
			"//button[@class='relative p-2 rounded-full bg-white/10 backdrop-blur-lg border border-white/20 hover:bg-white/20 transition-all']//*[name()='svg']");
	...
	By dashboardSectionTitle = By
			.xpath("//div[@class='grid grid-cols-1 md:grid-cols-2 gap-6']/div//div[@class='flex items-center']/span");
	By dashboardWeight = By
			.xpath("//*[@class='lucide lucide-scale h-4 w-4 text-[#9370DB] mr-1.5']/parent::div/following-sibling::p");
	By dashboardHeight = By
			.xpath("//*[@class='lucide lucide-ruler h-4 w-4 text-[#9370DB] mr-1.5']/parent::div/following-sibling::p");
	By dashboardBmi = By.xpath(
			"//*[@class='lucide lucide-activity h-4 w-4 text-[#9370DB] mr-1.5']/parent::div/following-sibling::p[1]");
	By dashboardCurrentWeight = By
			.xpath("//*[@class='lucide lucide-scale h-4 w-4 text-green-600 mr-1.5']/parent::div/following-sibling::p");
	By dashboardGoalWeight = By.xpath("//span[contains(text(),'Goal:')]");
	By dashboardSubscription = By.xpath(
			"//*[@class='lucide lucide-trending-down h-4 w-4 text-[#9370DB] mr-1.5']/ancestor::div[@class='flex items-center']/following-sibling::span");
	By dashboardInfo = By.xpath(
			"//h3[@class='text-sm font-medium text-gray-700']/following-sibling::span[@class='text-xs bg-[#9370DB] text-white px-2 py-0.5 rounded-full']");
	...
	By dashboardNoHealthText = By.xpath(
			"//span[normalize-space()='Health Conditions']/ancestor::div[@class='flex flex-col space-y-1.5 p-6 bg-[#F8F5FF] pb-3 pt-4 px-4']/following-sibling::div//p[@class='text-sm font-semibold text-green-600 mb-1']");
	...
	By dashboardSubJoinedDate = By.xpath(
			"//p[normalize-space()='Joined Date']/parent::div/following-sibling::p[@class='text-sm font-medium']");
	By dashboardSubTodayDate = By.xpath(
			"//p[contains(normalize-space(.), \"Today's Date\")]/parent::div/following-sibling::p[@class='text-sm font-medium']");
	...
	By sevenDayPlan = By.xpath(
			"//button[@class='bg-white text-green-600 px-6 py-2 rounded-full font-medium shadow-md hover:shadow-lg transition-all']");
	By seePremiumPlan = By.xpath(
			"//button[@class='bg-white text-[#6A5ACD] px-6 py-2 rounded-full font-medium shadow-md hover:shadow-lg transition-all']");
