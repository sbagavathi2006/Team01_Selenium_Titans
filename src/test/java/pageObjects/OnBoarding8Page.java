...
public class OnBoarding8Page {
	...
	public WebElement getDietCard(String dietOption) {
	    WebElement radio = getDietRadio(dietOption);
	    return radio.findElement(By.xpath("./ancestor::div[contains(@class,'border-2')][1]"));
	}

	public boolean isDietCardHighlighted(String dietOption) {
	    WebElement card = getDietCard(dietOption);
	    String borderColor = card.getCssValue("border-color");  // usually rgb(...)
	    return "rgb(106, 90, 205)".equals(borderColor); // #6A5ACD
	}
