...
public class MenstrualPhaseLogPage {
	...
	By menstrualDate = By
			.xpath("///*[@id=\"radix-:r3t:-content-overview\"]/div[1]/div[2]/div[1]/div[2]/div/div[1]/div[2]/span");
	By follicularDate = By
			.xpath("//*[@id=\"radix-:r3t:-content-overview\"]/div[1]/div[2]/div[1]/div[2]/div/div[2]/div[2]");
	By ovulationDate = By
			.xpath("//*[@id=\"radix-:r3t:-content-overview\"]/div[1]/div[2]/div[1]/div[2]/div/div[3]/div[2]");
	By lutealDate = By.xpath("//*[@id=\"radix-:r3t:-content-overview\"]/div[1]/div[2]/div[1]/div[2]/div/div[4]/div[2]");
	By CurrentPhaseStartedDate = By.xpath(
			"//div[contains(@class,'text-sm') and contains(@class,'text-gray-500')]//span[contains(text(),'Started')]");
	...
	public boolean isUpdateCycleInfoPresent() {
		List<WebElement> buttons = driver.findElements(By.xpath("//div[contains(@class,'flex-col')]//button"));
